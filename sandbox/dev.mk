...
dev.clean:
	...
	$(TF_BIN) -chdir=$(SANDBOX_DIR) destroy -auto-approve -var="sandbox_opnsense_iso=$(ISO_ABS_PATH)"
...
dev.plan: dev.validate
	...
	$(TF_BIN) -chdir=$(SANDBOX_DIR) plan -var="sandbox_opnsense_iso=$(ISO_ABS_PATH)" -out $(DEV_TF_PLAN)
...
dev.build: dev.init dev.validate dev.plan
	...
	$(TF_BIN) -chdir=$(SANDBOX_DIR) apply -auto-approve -var="sandbox_opnsense_iso=$(ISO_ABS_PATH)" $(DEV_TF_PLAN)
